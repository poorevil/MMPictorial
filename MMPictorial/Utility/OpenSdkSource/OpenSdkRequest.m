...
- (NSString *)generateRequestSignature:(NSURL *)url
	...
	for (NSString *key in sortedKeys) {
		...
		[paramsArray addObject:[NSString stringWithFormat:@"%@=%@", key, [value URLEncodedStringForQQ]]];
	}
	*normalQueryString = [paramsArray componentsJoinedByString:@"&"];

	NSString *requestSigBase = [NSString stringWithFormat:@"%@&%@&%@",
                               httpMethod, [*normalUrl URLEncodedStringForQQ], [*normalQueryString URLEncodedStringForQQ]];
    	
	NSString *requestSigKey = [NSString stringWithFormat:@"%@&%@", [appSecret URLEncodedStringForQQ], accessSecret ? [accessSecret URLEncodedStringForQQ] : @""];
...
- (NSString *)connectParams:(NSMutableDictionary *)params {
	...
	for (NSString *key in params) {
		...
		[tmpParamsArray addObject:[NSString stringWithFormat:@"%@=%@", key, [[params valueForKey:key] URLEncodedStringForQQ]]];
	}
...
- (NSString *)getRequestUrl:(NSString *)url
       ...
       [tmpQueryString appendFormat:@"&oauth_signature=%@", [signatureValue URLEncodedStringForQQ]];
