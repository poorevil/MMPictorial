...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        self.cancelButton.frame = CGRectMake(self.frame.size.width - 70, -5,35, 35);
        [self.cancelButton setImage:[UIImage imageNamed:@"rr_close.png"] forState:UIControlStateNormal];
        [self.cancelButton setImage:[UIImage imageNamed:@"rr_close_selected.png"] forState:UIControlStateHighlighted];
...
{
    //修改服务器页面的meta的值
    NSString *meta = [NSString stringWithFormat:@"document.getElementsByName(\"viewport\")[0].content = \"width=%f, initial-scale=0.85, minimum-scale=0.85, maximum-scale=0.85, user-scalable=no\"", 280.00];
