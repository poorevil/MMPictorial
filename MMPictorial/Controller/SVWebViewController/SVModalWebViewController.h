...
enum {
    ...
    SVWebViewControllerAvailableActionsShare2WeiXin     = 1 << 3,
    SVWebViewControllerAvailableActionsShare2QQWeiBo    = 1 << 4,
    SVWebViewControllerAvailableActionsShare2SinaWeiBo  = 1 << 5
};
