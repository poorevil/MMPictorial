...
@synthesize imageViews = _imageViews , currentlyDisplayingImageIndex = _currentlyDisplayingImageIndex;
...
- (void)_init
{
    ...
    self.currentlyDisplayingImageIndex = kJSAnimatedImagesViewNoImageDisplayingIndex;
}
...
//    while (nextImageToShowIndex == self.currentlyDisplayingImageIndex);
    ...
    //edited by hanchao
    nextImageToShowIndex = (self.currentlyDisplayingImageIndex + 1) % totalImages;
    
    self.currentlyDisplayingImageIndex = nextImageToShowIndex;
